            ...
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        ...
                        <p>Get started with adding contacts in your network. Organize them by groups. <span className="small">(Don't have any Groups created yet? <Link to="/groups">Create a Group now!</Link></span></p>
                        </div>
                    </div>
                </div>
                <div className="row">
