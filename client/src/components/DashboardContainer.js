        ...
        <div className="container mt-3">
            <div className="row">
                <div className="col-6 col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    ...
                    <p>The dashboard is your launchpad to creating contacts, groups, templates, and plans. You'll get a birds-eye view of the latest activity and status of your plans, and you can quickly activate a plan right from this dashboard.</p>
                    <hr />
                    <h6>Your Plans</h6>
                    <ListPlans />
