...
const PlanItem = (props) => {
    ...
    const handleSubmit = (event) => {
        ...
        axios
            .put(`/api/plans/update/${state.user.id}/${props.plan.id}`, {
                id: selectedPlan.id,
        ...
        return (
            <>
                <Card planid={props.plan.id} className="mb-1" key={`plan-${props.plan.id}`}>
                    <div className="row">
                        <div className="col-10">&nbsp;<small><strong>{props.plan.planname}</strong></small></div>
                            ...
                            <Tab eventKey={`plan1-${props.plan.id}`} title="Activate">
                                <div className="mt-2">
                                    <p className="small" style={{ lineHeight: "1" }}>
                                                        Once your <strong><em>{props.plan.planname}</em></strong> Flare plan is ready to turn on, you can activate it below.
                                    </p>
                                    {/* <Row className="mt-4">
                                        <Col>
                                            <Form.Check
