...
import SendUpFlare from "../../components/SendUpFlare";
import SetUpFlare from "../../components/SetUpFlare";
      ...
      <div id="wrapper">
        <div className="col-lg-12 col-sm-12 col-md-12">
          ...
          <div>
            ...
            <Route exact path="/prototype-send" component={SendUpFlare} />
            <Route exact path="/prototype-add" component={SetUpFlare} />
